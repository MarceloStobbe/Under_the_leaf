...
Under the Leaf is an interactive web application developed with Flask (Python), created for plant enthusiasts who want to better care for their green companions. The project offers a plant health diagnostic tool, environment guides, educational content, organic fertilizer recipes, a community forum, user authentication, and an integrated database system.
...
* **Community Forum**: An interactive space for users to share experiences and connect.
...
## 🛠 Technologies Used
* **Back-end**: Python, Flask, Flask-SQLAlchemy (Database models), Flask-WTF (Forms).
* **Front-end**: HTML5, CSS3, Bootstrap 5, Jinja2.
* **Architecture**: Modular structure containing routes, diagnostics, database models, and form management.
